...
$$ y(x) = \phi_1 * \left( 1 - e^{-\phi_2 * (x-\phi_3)} \right) $$ em que $\phi_1$ é a assintota quando $x \rightarrow \infty$, $\phi_2$ corresponde a meia vida $t_{0.5}= ln(2) / \phi_2$, e $\phi_3$ é o valor de $x$ quando $y=0$.
